...
class GPTSoVITSModel:
    ...
    def infer_zero_shot(
        ...
        try:
            ...
            sf.write(str(output_path), audio_numpy, 44100, subtype="PCM_16")

            msg = f"Zero-shot inference completed, saved to {output_path}"
            logger.info(msg)

        except Exception as e:
            error_msg = f"Zero-shot inference failed: {str(e)}"
    ...
    def infer_few_shot(
        ...
        try:
            ...
            msg = f"Few-shot inference completed, saved to {output_path}"
            logger.info(msg)
